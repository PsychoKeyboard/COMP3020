...
function search(){
    ...
    // Convert priorityRecipesList to a string
    const priorityListString = JSON.stringify(priorityRecipesList);
    // Pass the string to the next page
    window.location.href = `Reciperesults.html?priorityList=${priorityListString}`;
}
